...
export async function GET(request: Request) {
  ...
  const { data: businesses, error: businessesError } = await supabaseAdmin
    .from("businesses")
    .select(
      "id, name, slug, plan_status, public_booking_enabled, trial_started_at, trial_ends_at, subscription_started_at, subscription_ends_at, subscription_status, payment_failed_at, plan_name, stripe_customer_id, stripe_subscription_id, stripe_price_id, profile_image_url, created_at"
    )
